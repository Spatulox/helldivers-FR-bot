...
exports.executeSelectMenu = executeSelectMenu;
// Slashes command in alphabetical order...
const discord_js_1 = require("discord.js");
const embeds_1 = require("../utils/messages/embeds");
const wikiSubject_1 = require("./execute/wikiSubject");
const wikiListSubthematics_1 = require("./execute/wikiListSubthematics");
const wikiListSubjects_1 = require("./execute/wikiListSubjects");
function executeSelectMenu(interaction) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!interaction.isAnySelectMenu())
            return;
        const selectedValue = interaction.values[0]; // Get first selected value
