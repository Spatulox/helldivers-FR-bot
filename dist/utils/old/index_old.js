...
const checkInternetCo_1 = require("../server/checkInternetCo");
...
//import { handleAutomatonIntrusion } from './sub_games/AutomatonIntrusion/AutomatonIntrusionDiscord';
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        client_1.client.on(discord_js_1.Events.ClientReady, () => __awaiter(this, void 0, void 0, function* () {
            const jobs = new ScheduleJobs_1.ScheduleJobs();
            jobs.handleScheduleJobs();
        ...
        client_1.client.on(discord_js_1.Events.MessageCreate, (message) => __awaiter(this, void 0, void 0, function* () {
            //handleAutomatonIntrusion(message, client)
