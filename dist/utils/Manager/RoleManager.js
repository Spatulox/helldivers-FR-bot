...
class RoleManager {
    ...
    static findPriorityRole(roles) {
        ...
        roles.forEach(role => {
            ...
            if (match) {
                ...
                if (RoleManager.isPriorityEmoji(content)) {
                    roleToKeep = role;
                    return;
                }
                else if (RoleManager.questionMarkRegex.test(content)) {
     ...
     */
    static removeRole(member, roleName) {
        return __awaiter(this, void 0, void 0, function* () {
            simplediscordbot_1.Bot.log.info(`Suppression du rôle : ${roleName} pour : ${member.displayName}`);
            try {
    ...
    static addRole(membreId, roleId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!membre || !role) {
                    simplediscordbot_1.Bot.log.info(`Membre ou rôle non trouvé lors de l'assignation du rôle (Membre: <@${membreId}>, Rôle: <&@${roleId}>)`);
                    return false;
                }
                ...
                simplediscordbot_1.Bot.log.info(`Erreur lors de l'ajout du rôle: ${errorMessage}`);
                return false;
            }
        });
    }
    ...
    static addMissingRole(member) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (changes.length > 0) {
                ...
                simplediscordbot_1.Bot.log.info(`Mise à jour des rôles pour ${username} :\n- ${changes.join('\n- ')}`);
            }
        });
    }
}
exports.RoleManager = RoleManager;
RoleManager.questionMarkRegex = /(\?{2})+/;
