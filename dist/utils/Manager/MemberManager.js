    ...
    */
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < membersArray.length; i++) {
                ...
                try {
                    ...
                    yield MemberManager.checkAndUpdateMember(member);
                    yield MemberManager.isVerifiedMember(member);
            ...
            simplediscordbot_1.Log.info("Number of person unpingable : " + MemberManager.numberOfUnpingable);
            return updatedMembers;
        });
    }
    /**
    ...
    static checkAndUpdateMember(newMember) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!MemberManager.isUsernamePingable(newMember)) {
            ...
            if (matchingRoles.size > 0) { // Si au moins un role
                const priorityRole = RoleManager_1.RoleManager.findPriorityRole(matchingRoles);
                if (priorityRole) {
                    try {
                        // Nettoyage des rôles non prioritaires
                        yield RoleManager_1.RoleManager.updateMemberRoles(newMember, matchingRoles, priorityRole);
                        ...
                        if (!seicRole && (!newMember.nickname || !newMember.nickname.includes(priorityRole.name))) {
                            const formattedNick = MemberManager.cleanNickname(newMember, priorityRole.name, forcedNickname);
            ...
            */
            if (forcedNickname) {
                ...
                const formattedNick = MemberManager.cleanNickname(newMember, role, forcedNickname);
    ...
    static handleMemberUpdate(newMember) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield MemberManager.checkAndUpdateMember(newMember);
                yield MemberManager.isVerifiedMember(newMember);
            }
            catch (err) {
    ...
    static handleNewMember(member) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield MemberManager.checkMemberWithDelay(member, 1);
            yield MemberManager.checkMemberWithDelay(member, 5);
        });
    }
}
