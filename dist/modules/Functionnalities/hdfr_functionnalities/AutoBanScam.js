...
class AutoBanScam extends Modules_1.Module {
    constructor() {
        if (AutoBanScam._instance) {
            return AutoBanScam._instance;
        }
        super("AutoBanScam", "Automatically ban person who send message in <#1437904268467376268>. Also remove the \"{user} a reçu un avertissement\"");
        AutoBanScam._instance = this;
    }
    static get instance() {
        return AutoBanScam._instance;
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.author.bot) {
                try {
                    ...
                    let title = (0, members_1.isStaff)(auth) ? sanction_1.SanctionTitle.EXCLUSION_7D : sanction_1.SanctionTitle.BANNISSEMENT;
