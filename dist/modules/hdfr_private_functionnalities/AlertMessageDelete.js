...
class AlertMessageDelete extends discord_module_1.Module {
    ...
    constructor() {
        super();
        this.name = "Alert Message Delete";
        this.description = "Module which send the deleted message to a modo channel, in order to check if there is any weird images/content";
    }
