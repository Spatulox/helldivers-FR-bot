...
const jsonCache = {};
/**
 * This class is used to load handlers json file dynamically, based on the "DEV" env var
 */
class Handlers {
    static get path() {
     ...
     */
    static load(bot, category, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = `./src/${bot}/handler/${category}${this.path}/${fileName}`;
            try {
