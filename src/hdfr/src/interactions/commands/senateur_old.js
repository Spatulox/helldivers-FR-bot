    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isDetected) {
            try {
                ...
                if (member && !GlobalMemberManager_1.GlobalMemberManager.HDFR.isStaffInteraction(interaction)) {
...
function handleRoleAssignment(interaction, balles, isGonnaDie) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let attempt = 1; attempt <= 5; attempt++) {
            if (yield HDFRRoleManager_1.HDFRRoleManager.addRole(member.id, roleId)) {
