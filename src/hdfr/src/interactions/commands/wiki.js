...
function wikiMenu(interaction) {
    return __awaiter(this, void 0, void 0, function* () {
        const file = yield simplediscordbot_1.FileManager.readJsonFile("./src/hdfr/wikiContents/thematics.json");
        try {
            const description = new builders_1.EmbedBuilder()
                .setColor(16771082)
                .setTitle('WIKI')
                .setThumbnail(file.thumbnail);
            const direct = yield simplediscordbot_1.FileManager.listDirectories("./src/hdfr/wikiContents/");
            ...
            try {
                for (const dir of direct) {
                    ...
                    const optionBuilder = new builders_1.StringSelectMenuOptionBuilder()
                        ...
                        .setValue(`./src/hdfr/wikiContents/${label}`);
